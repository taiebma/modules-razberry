...
//		if (zway.devices[15].instances[0].Basic.data.level.value == "off" || zway.devices[15].instances[0].Basic.data.level.value == null) {
...
//		if (zway.devices[15].instances[0].Basic.data.level.value == true || zway.devices[15].instances[0].Basic.data.level.value == null) {
			...
			//  On verifie qu'il est bien ferme sinon on recommence
				self.timer = setTimeout(function () {
					if (controller.devices.get("ZWayVDev_zway_Remote_15-0-0-B").get("metrics:level") == "on") {
//					if (zway.devices[15].instances[0].Basic.data.level.value == true) {
