...
Meteo.prototype.init = function (config) {
    ...
    //executeFile(this.moduleBasePath()+"/MeteoDevice.js");

    //this.vdev = new MeteoDevice("MeteoDevice1", this.controller, 4, 0, 1);
    //this.vdev.init();
    ...
    this.vdevTempExt = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-49-1",
        defaults: {
    ...
    this.vdevTempInt = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-49-2",
        defaults: {
            deviceType: "sensorMultilevel",
            probeType: "temperature",
            metrics: {
    ...
    this.vdevTempCave = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-49-3",
        defaults: {
            deviceType: "sensorMultilevel",
            probeType: "temperature",
            metrics: {
    ...
    this.vdevFcSum = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-49-4",
        defaults: {
            deviceType: "sensorMultilevel",
            probeType: "temperature",
            metrics: {
    ...
    this.vdevFcTemp = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-49-5",
        defaults: {
            deviceType: "sensorMultilevel",
            probeType: "temperature",
            metrics: {
    ...
    this.vdevFerie = this.controller.devices.create({
        deviceId: "ZWayVDev_zway_" + this.id + "-0-37-6",
        defaults: {
    ...
    //this.vdev.instances = [ 1 ];
    this.releve = { };
    this.forecast = { };

//    self.controller.emit('zway.structureUpdate', ZWAY_DEVICE_CHANGE_TYPES[0x01], self.vdev.id);
//    self.controller.emit('zway.structureUpdate', ZWAY_DEVICE_CHANGE_TYPES[0x04], self.vdev.id, "Luminosite1");
//    self.controller.emit('zway.structureUpdate', ZWAY_DEVICE_CHANGE_TYPES[0x10], self.vdev.id, "Luminosite1", 0x32);
